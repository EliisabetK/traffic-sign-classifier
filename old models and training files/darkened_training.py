...
def augment_with_darkening_and_noise(generator, X, y, batch_size=32, darken_factor=0.7, noise_factor=0.1):
    while True:
        for X_batch, y_batch in generator.flow(X, y, batch_size=batch_size):
            darkened_X_batch = np.array([darken_image(img, darken_factor) for img in X_batch])
...
train_generator = augment_with_darkening_and_noise(train_datagen, X_train, y_train)

val_datagen = ImageDataGenerator()
val_generator = augment_with_darkening_and_noise(val_datagen, X_val, y_val)
