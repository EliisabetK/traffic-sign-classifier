...
def preprocess_image_with_noise_and_blur(img_path, noise_probability=0.8, blur_probability=0.6, darken_probability=0.3, darken_factor=0.8):
...
for label_id, label_name in zip(labels_df['ClassId'], labels_df['Name']):
    ...
    for img_name in os.listdir(label_folder):
        ...
        img = preprocess_image_with_noise_and_blur(img_path, noise_probability=0.8, blur_probability=0.6, darken_probability=0.3, darken_factor=0.8) 
        images.append(img)
...
for img_name in os.listdir(test_dir):
    ...
    img = preprocess_image_with_noise_and_blur(img_path, noise_probability=0.8, blur_probability=0.6, darken_probability=0.8, darken_factor=0.7)
